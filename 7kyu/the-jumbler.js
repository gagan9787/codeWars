...
function jumbler(indices) {
  ...
  console.log(jumbler([1, 0]));
  console.log(jumbler([2, 0, 1]));
  console.log(jumbler([3, 0, 1, 2]));
  console.log(jumbler([3, 1, 4, 2, 0]));
  console.log(jumbler([5, 3, 1, 0, 4, 2]));
  console.log(jumbler([5, 2, 4, 0, 1, 6, 3]));
  console.log(jumbler([5, 3, 6, 7, 0, 4, 1, 2]));
  console.log(jumbler([2, 6, 8, 3, 5, 4, 0, 7, 1]));
